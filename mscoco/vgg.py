...
# VGG model class to be used as an encoder of each image into a feature vector embedding to be given as first input to
# the RNN. Class model is borrowed from https://github.com/machrisaa/tensorflow-vgg which loads the weights transformed
# from caffe model zoo
class Vgg16:
