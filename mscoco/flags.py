...
tf.app.flags.DEFINE_boolean('train_embedding_network', True,
...
tf.flags.DEFINE_integer("test_images_use", 5000, """How many image to evaluate the trained models on""")
tf.flags.DEFINE_integer("finetune_cnn_after", 0, """Start fine tunning the CNN network after a number of epochs. -1 do not finetune""")
